function TKLTG(e) {
    ...
    if (valid) {
        const targetUrl = 'https://ketqua5s.com/?url=' + btoa('https://ketqua.vn/thong-ke/loto-gan');
...
function TKCKDLT(e) {
    ...
    if (valid) {
        const targetUrl = 'https://ketqua5s.com/?url=' + btoa('https://ketqua.vn/thong-ke/chu-ky-dan-loto');
        const formData = new URLSearchParams();
...
function TKN(e) {
    ...
    if (valid) {
        const targetUrl = 'https://ketqua5s.com/?url=' + btoa('https://ketqua.vn/thong-ke/ket-qua-xo-so');
        const formData = new URLSearchParams();
        formData.append('numbers', numbers);
        formData.append('province', provinceId);
...
function TKDDLT(e) {
    ...
    const targetUrl = 'https://ketqua5s.com/?url=' + btoa('https://ketqua.vn/thong-ke/dau-duoi-loto');
    const formData = new URLSearchParams();
    formData.append('date_range', dateRange);
    formData.append('province', provinceId);
...
function TKCKDDB(e) {
    ...
    if (valid) {
        const targetUrl = 'https://ketqua5s.com/?url=' + btoa('https://ketqua.vn/thong-ke/chu-ky-dan-dac-biet');
        const formData = new URLSearchParams();
        formData.append('range', dateRange);
        formData.append('numbers', numbers);
        formData.append('province', provinceId);
...
function TKTSLT(e) {
    ...
    if (valid) {
        const targetUrl = 'https://ketqua5s.com/?url=' + btoa('https://ketqua.vn/thong-ke/tan-suat-loto');
        const formData = new URLSearchParams();
        formData.append('province', provinceId);
        formData.append('date_range', dateRange);
...
function TC(e) {
    ...
    const targetUrl = 'https://ketqua5s.com/?url=' + btoa('https://ketqua.vn/thong-ke/cang-loto');
    const formData = new URLSearchParams();
...
function TKTT(e) {
    ...
    const targetUrl = 'https://ketqua5s.com/?url=' + btoa('https://ketqua.vn/thong-ke/theo-tong');
    const formData = new URLSearchParams();
...
function TKQT(e) {
    ...
    const targetUrl = 'https://ketqua5s.com/?url=' + btoa('https://ketqua.vn/thong-ke/quan-trong');
    const formData = new URLSearchParams();
    formData.append('province_id', provinceId);
...
function BDBT(e) {
    ...
    const targetUrl = 'https://ketqua5s.com/?url=' + btoa('https://ketqua.vn/thong-ke/dac-biet-tuan');
    const formData = new URLSearchParams();
...
function TKDN(e) {
    ...
    const targetUrl = 'https://ketqua5s.com/?url=' + btoa('https://ketqua.vn/thong-ke/dai-nhat');
    const formData = new URLSearchParams();
    formData.append('numbers', numbers);
    formData.append('from_date', fromDate);
    formData.append('to_date', toDate);
...
function TSNLT(e) {
    ...
    if (valid) {
        const targetUrl = 'https://ketqua5s.com/?url=' + btoa('https://ketqua.vn/thong-ke/tan-so-nhip-loto');
        const formData = new URLSearchParams();
        formData.append('number', number);
        formData.append('from_date', fromDate);
        formData.append('to_date', toDate);
...
function BDBTH(e) {
    ...
    const targetUrl = 'https://ketqua5s.com/?url=' + btoa('https://ketqua.vn/thong-ke/dac-biet-thang');
    const formData = new URLSearchParams();
