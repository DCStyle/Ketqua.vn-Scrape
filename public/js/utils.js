...
export const Utils = {
    ...
    /**
     * Empty check with loading fallback
     */
    checkEmpty(string, loading = '<div class="loading"></div>') {
        return string === '' || string == null ? loading : string;
    },
     ...
     * Scroll to element
     */
    scrollToElement(elementId, offset = 50) {
