<div class="row form-margin m-b-5">
    <div class="col-sm-6 form-padding">
        ...
        <select class="form-select" id="tkckdlt_province_id">
    ...
    <div class="col-sm-6 form-padding">
        ...
        <input class="form-control daterangepick" id="tkckdlt_date_range" name="range" value="01/01/2016 - {{ now()->format('d/m/Y') }}" placeholder="Chọn khoảng ngày">
        <p class="text text-danger mb-0" for="tkckdlt_date_range"></p>
    </div>
</div>
<div class="row form-margin m-b-5">
    <div class="col form-padding">
        <lable class="fw-medium txt-sub-content d-block m-b-5">Các bộ số cần thống kê</lable>
        <textarea class="form-control" id="tkckdlt_numbers" rows="3" placeholder="Nhập vào các bộ số để tạo dàn (Ngăn cách bằng dấu phẩy)">01 02 03 04</textarea>
        <p class="text text-danger mb-0" for="tkckdlt_numbers"></p>
    </div>
</div>
<div class="row form-margin">
    <div class="col-sm-6 form-padding align-self-center">
        <div class="form-check">
            <input class="form-check-input" type="checkbox" value="1" id="tkckdlt_is_check">
            <label class="form-check-label" for="tkckdlt_is_check">
                Kiểm tra cả dàn cùng về
            </label>
        </div>
    </div>
    <div class="col-sm-6 form-padding">
        <button id="auto-click-button" class="btn text-white bg-btn w-100 text-nowrap line-clamp-1" onclick="TKCKDLT(this);">Xem kết quả</button>
    </div>
</div>
