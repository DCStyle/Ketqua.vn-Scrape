<div class="row form-margin">
    <div class="col-sm-4 form-padding">
        ...
        <select class="form-select" id="tkddlt_province_id">
    ...
    <div class="col-sm-5 form-padding">
        ...
        <input class="form-control daterangepick" value="17/12/2024 - {{ now()->format('d/m/Y') }}" id="tkddlt_date_range" placeholder="Chọn khoảng ngày">
        <p class="text text-danger mb-0" for="tkddlt_date_range"></p>
    </div>
    <div class="col-sm-3 form-padding align-self-end">
        <button id="auto-click-button" class="btn text-white bg-btn w-100 text-nowrap line-clamp-1" onclick="TKDDLT(this);">Xem kết quả</button>
    </div>
</div>
